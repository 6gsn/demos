...
Sample 1: **"メキシコ留学中の、エーケービーフォーティーエイト入山杏奈が一時帰国。"**

| Recording			| X						| IP					|
|-----------------------|-----------------------|-----------------------|
| <audio controls src="https://6gsn.github.io/demos/samples/tasks/sample01/record.wav"></audio> | <audio controls src="https://6gsn.github.io/demos/samples/tasks/sample01/x.wav"></audio> | <audio controls src="https://6gsn.github.io/demos/samples/tasks/sample01/ip.wav"></audio> |
...
| IP+AN					| AP+AN					| IP+AP+AN				|
|-----------------------|-----------------------|-----------------------|
| <audio controls src="https://6gsn.github.io/demos/samples/tasks/sample01/ip_an.wav"></audio> | <audio controls src="https://6gsn.github.io/demos/samples/tasks/sample01/ap_an.wav"></audio> | <audio controls src="https://6gsn.github.io/demos/samples/tasks/sample01/ip_ap_an.wav"></audio> |

<br/>

Sample 2: **"最初にすることは早起き、次にするのが二度寝、その次が後悔。"**

| Recording			| X						| IP					|
|-----------------------|-----------------------|-----------------------|
| <audio controls src="https://6gsn.github.io/demos/samples/tasks/sample02/record.wav"></audio> | <audio controls src="https://6gsn.github.io/demos/samples/tasks/sample02/x.wav"></audio> | <audio controls src="https://6gsn.github.io/demos/samples/tasks/sample02/ip.wav"></audio> |
...
| IP+AN					| AP+AN					| IP+AP+AN				|
|-----------------------|-----------------------|-----------------------|
| <audio controls src="https://6gsn.github.io/demos/samples/tasks/sample02/ip_an.wav"></audio> | <audio controls src="https://6gsn.github.io/demos/samples/tasks/sample02/ap_an.wav"></audio> | <audio controls src="https://6gsn.github.io/demos/samples/tasks/sample02/ip_ap_an.wav"></audio> |
...
| Recording			| X						| IP					|
|-----------------------|-----------------------|-----------------------|
| <audio controls src="https://6gsn.github.io/demos/samples/tasks/sample03/record.wav"></audio> | <audio controls src="https://6gsn.github.io/demos/samples/tasks/sample03/x.wav"></audio> | <audio controls src="https://6gsn.github.io/demos/samples/tasks/sample03/ip.wav"></audio> |
...
| IP+AN					| AP+AN					| IP+AP+AN				|
|-----------------------|-----------------------|-----------------------|
| <audio controls src="https://6gsn.github.io/demos/samples/tasks/sample03/ip_an.wav"></audio> | <audio controls src="https://6gsn.github.io/demos/samples/tasks/sample03/ap_an.wav"></audio> | <audio controls src="https://6gsn.github.io/demos/samples/tasks/sample03/ip_ap_an.wav"></audio> |
